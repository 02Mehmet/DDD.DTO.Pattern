...
{
    public abstract class ValueObject1 : IEquatable<ValueObject1>
    {
        private List<PropertyInfo> _properties;
        private List<FieldInfo> _fields;

        public static bool operator ==(ValueObject1 obj1, ValueObject1 obj2)
        {
        ...
        public bool Equals(ValueObject1 obj)
        {
